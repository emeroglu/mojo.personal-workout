...
{
    public class Previewer : CoreProcessor<CoreMaterial>
    {
        ...
        private Task UI_Downloading()
        {
            return new Task()
            {
                ...
                {
                    txtPreview = (Variables.UI["txtPreview"] as UIText).Element;
                    txtPreview.text = "Downloading...";
        ...
        private Task Mojo_Preview_Interaction()
        {
            return new Task()
            {
                Mission = "Mojo_Preview_Interaction",
                Action = (seekTo, currentTask, nextTask, delivery) =>
                {
                    new HttpPostRequestSender()
                    {
                        ...
                        {
                            Url = Config.URLs.Mojo_Previewed,
                        ...
                        OnSuccess = (www) => 
                        {
                            Variables.Current_Mojo.soundtrack = JsonConvert.DeserializeObject<JsonSoundtrack>(www.text);
                ...
                Action = (seekTo, currentTask, nextTask, delivery) =>
                {
                    if (downloadEnvironment)
                    {
                        new ContentDownloader()
                        {
                            ...
                            OnFinish = () =>
                            {
                                txtPreview.text = "Environment downloaded...";
                    ...
                    {
                        txtPreview.text = "Environment already downloaded...";
                ...
                Action = (seekTo, currentTask, nextTask, delivery) =>
                {
                    if (downloadAvatar)
                    {
                        new ContentDownloader()
                        {
                            ...
                            OnFinish = () =>
                            {
                                txtPreview.text = "Character downloaded...";
                    ...
                    {
                        txtPreview.text = "Character already downloaded...";
                ...
                Action = (seekTo, currentTask, nextTask, delivery) =>
                {
                    if (downloadAudio)
                    {
                        new ContentDownloader()
                        {
                            ...
                            OnFinish = () =>
                            {
                                txtPreview.text = "Soundtrack downloaded...";
                    ...
                    {
                        txtPreview.text = "Soundtrack already downloaded...";
                ...
                Action = (seekTo, currentTask, nextTask, delivery) =>
                {
                    new UIRenderer()
                    {
                        Material = new UIRendererMaterial()
                        {
                            ...
                            Component = new pnlPreviewFrame(OnFail)
                        },
                        OnFinish = () =>
                        {
                            new StateBroadcaster()
                    ...
                    new Suspender()
                    {
                        ...
                        OnFinish = () =>
                        {
                            new StateBroadcaster()
                            {
                                Material = new StateBroadcasterMaterial()
                                {
                                    State = "Delayed_Preview"
                                },
                                OnFinish = () => { txtPreview.text = "Preview"; }                                
                            }
                            .Broadcast();
