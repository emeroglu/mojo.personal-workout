...
{
    public class pageAbout_2 : UIPage
    {
        public pageAbout_2(UIDirection direction, UIPageHeight height) : base(direction, height) { }
            ...
            return new List<UIComponent>()
            {
                new UIImage()
                {
                    ...
                    Idle = new UIIdleImage()
                    {
                        ...
                        Url = "Images/about_what"
                    }
                },                
                new UIPanel()
                {
                    Name = "pnlAboutPageBottomBar_2",
                                    ...
                                    new OnTouchListener()
                                    {
                                        ...
                                        OnRelease = (go) =>
                                        {
                                            ...
                                            new UIPageRenderer<listItem>()
                                            {
                                                Material = new UIPageRendererMaterial<listItem>()
                                                {
                                                    Page = new pageAbout_3(UIDirection.FROM_RIGHT, UIPageHeight.TALL)                                               
                                                }
                                            }
                                            .Render();
                                        }
