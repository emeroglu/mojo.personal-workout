...
{
    public class pageAbout_3 : UIPage
    {
        public pageAbout_3(UIDirection direction, UIPageHeight height) : base(direction, height) { }
            ...
            return new List<UIComponent>()
            {
                new UIImage()
                {
                    ...
                    Idle = new UIIdleImage()
                    {
                        ...
                        Url = "Images/about_character"
                    }
                },                
                new UIPanel()
                {
                    Name = "pnlAboutPageBottomBar_3",
                                    ...
                                    new OnTouchListener()
                                    {
                                        ...
                                        OnRelease = (go) =>
                                        {
                                            ...
                                            new UIPageRenderer<listItem>()
                                            {
                                                Material = new UIPageRendererMaterial<listItem>()
                                                {
                                                    Page = new pageAbout_4(UIDirection.FROM_RIGHT, UIPageHeight.TALL)                                               
                                                }
                                            }
                                            .Render();
                                        }
