...
{
    public class pageAbout_4 : UIPage
    {
            ...
            return new List<UIComponent>()
            {
                new UIImage()
                {
                    ...
                    Idle = new UIIdleImage()
                    {
                        ...
                        Url = "Images/about_soundtrack"
                    }
                },                
                new UIPanel()
                {
                    Name = "pnlAboutPageBottomBar_4",
                                    ...
                                    new OnTouchListener()
                                    {
                                        ...
                                        OnRelease = (go) =>
                                        {
                                            ...
                                            new UIPageRenderer<listItem>()
                                            {
                                                Material = new UIPageRendererMaterial<listItem>()
                                                {
                                                    Page = new pageAbout_5(UIDirection.FROM_RIGHT, UIPageHeight.TALL)                                               
                                                }
                                            }
                                            .Render();
                                        }
